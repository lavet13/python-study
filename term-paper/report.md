...
![Диаграмма размаха: price_rub до фильтрации](lab-02/plot_07_boxplot_before.png)
...
Правило 3σ удалило лишь 14 записей (0,7%) — гистограмма практически
не изменилась. Метод предполагает нормальное распределение, поэтому
недостаточно чувствителен к правостороннему хвосту.
...
IQR-метод строже (удалено 62 строки против 14) и не зависит от
формы распределения — граница 31,3 млн срезает правый хвост,
гистограмма приобретает более симметричный вид.
